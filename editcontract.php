	        ...
	        <div class="mediumtxt boldtxt successtxt" align="center"><?php echo $success;?></div>
			    ...
			    <td colspan="2">&nbsp;</td>
                    ...
                    <tr>
                            ...
                            <td>:</td>
                            <td>
                            	<select disabled="disabled" name="projectId" id="projectId" style="width:250px;" onchange="return loadClients(this.value);">
	                ...
	                <tr>
                            ...
                            <td>:</td>
                            <td><select disabled="disabled" name="clientId" id="clientId" style="width:250px;">
                                    <option value="">-Select-</option>
                    ...
                    <tr>
                            ...
                            <td>:</td>
                            <td>
                            	<input type="text" readonly="readonly" name="txtItem" id="txtItem" value="<?php echo $contractDetail['item']?>" style="width:250px;" maxlength="60">
                            </td>
                    </tr>
                    <tr>
