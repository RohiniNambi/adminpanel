...
$teams = new WORKERS;
$teamlist = $teams->getWorkerTeamList();
		...
		<input type="hidden" name="createdBy" value="<?php echo trim($session_id);?>"> 
	        ...
	        <div class="mediumtxt boldtxt successtxt" align="center"><?php echo $success;?></div>
                <table cellpadding="0" cellspacing="0" border="0" class="mediumtxt">			
                    <tr>	
			    <td colspan="2"></td>
                            <td><strong class="bigtxt">Add Worker</strong></td>				
                    </tr>
                    <tr>
					...
					<tr>
                            ...
                            <td><select name="teamId" id="teamId" onchange="return chkUserType(this.value);">
								    ...
								    <?php foreach($teamlist as $key=>$values){ ?>
									   <option value="<?php echo $values["teamid"];?>"><?php echo $values["teamName"]?></option>
